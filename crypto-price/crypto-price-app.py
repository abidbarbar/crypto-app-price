...
st.markdown("""
this app reviews cryptocurrency prices for the top 100 cryptocurrency from the **CoinMarkerCap**
""")

# about
expander_bar = st.expander('About')
expander_bar.markdown("""
* **python libraries** : base64, streamlit, pandas, matplotlib, requests, josn, time
...
# web scraping of CoinMarkerCap data
@st.cache
def load_data():
    ...
    index_of_quote_currency_price = attributes.index(f"quote.{currency_price_unit}.price")
    index_of_quote_currency_percent_change_1h = attributes.index(f"quote.{currency_price_unit}.percentChange1h")
    index_of_quote_currency_percent_change_24h = attributes.index(f"quote.{currency_price_unit}.percentChange24h")
    index_of_quote_currency_percent_change_7d = attributes.index(f"quote.{currency_price_unit}.percentChange7d")
    index_of_quote_currency_market_cap = attributes.index(f"quote.{currency_price_unit}.marketCap")
    index_of_quote_currency_volume_24h = attributes.index(f"quote.{currency_price_unit}.volume24h")
...
def filedownload(df):
    ...
    href = f'<a href="data:file/csv;base64,{b64}" download="crypto.csv">Download Crypto.csv</a>'
    return href
